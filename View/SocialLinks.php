...
class SocialLinks {
    public static function render($url) {
        ...
        $output .= '<div class="share email"><a href="mailto:?body=I thought you might find this page interesting: %0D%0A%0D%0A' . Scrub::toURL($url) . '" title="Email"><i class="fa fa-send"></i> Email</a></div>';
        $output .= '</div>';
        return $output;
    }
}
