module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    sass: {
      dist: {
        ...
        files: {
          ...
          '../../css/lightning.css': 'scss/lightning.scss',
          '../../css/ckeditor/contents.css': 'scss/ckeditor_contents.scss'
        }
      }
    },
    ...
    uglify: {
      ...
      dist: {
        files: {
          '../../js/foundation.min.js': ['<%= foundation.js %>'],
      ...
      vendor: {
        files: {
          '../../js/placeholder.js': '<%= vendor %>/jquery-placeholder/jquery.placeholder.js',
          '../../js/fastclick.js': '<%= vendor %>/fastclick/lib/fastclick.js',
          '../../js/jquery.cookie.js': '<%= vendor %>/jquery.cookie/jquery.cookie.js',
          '../../js/jquery.js': '<%= vendor %>/jquery/dist/jquery.js',
          '../../js/modernizr.js': '<%= vendor %>/modernizr/modernizr.js',
          '../../js/lightning.js': '../../Lightning/JSSource/*.js',
          '../../js/chart.min.js': ['../../Lightning/Vendor/chartjs/*.js'],
