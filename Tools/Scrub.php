...
class Scrub {
     ...
     */
    const SCRUB_BASIC_HTML = 'p,b,a[href|name|target|title],i,u,strong,em,img[src|width|height],table[cellpadding|cellspacing|border],tr,td,tbody,hr,h1,h2,h3,h4,h5,h6,*[id|name|align|style|alt|class],sup,sub,ul,ol,li,span,font[color|size],div,br,blockquote,code,pre';
    /**
