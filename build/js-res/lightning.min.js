...
!function(){var self=lightning.forms={formSubmit:function(e){var form=$(e.target).closest("form"),url=form.data("ajax-action");if(url||(url=form.prop("action")),!self.validateForm(e))return!1;var container=form.find(".loading-container");0===container.length&&(container=form.closest(".loading-container")),0===container.length&&(container=form.addClass("loading-container"));var veil=container.children(".white-veil");0===veil.length&&(container.prepend('<div class="white-veil"><div class="spinner"></div></div>'),veil=container.children(".white-veil")),setTimeout(function(){veil.show(),veil.css("opacity",.5)},100),$.ajax({url:url,type:"POST",data:form.serializeArray(),success:function(data){var successCallbackName=form.data("ajax-success");successCallbackName&&window[successCallbackName]&&window[successCallbackName]();var successEval=form.data("ajax-success-eval");successEval&&eval(successEval),veil.fadeOut()},error:function(){veil.fadeOut()}})},init:function(){$(".captcha_container").closest("form").submit(function(){var e=$(this),a=0!==grecaptcha.getResponse().length;return $("#captcha_abide").val(a?1:""),e&&a}),$('form[data-abide="ajax"]').on("valid.fndtn.abide",self.formSubmit)},initInvisibleCaptcha:function(){if("undefined"==typeof grecaptcha||!grecaptcha.render)return void setTimeout(self.initInvisibleCaptcha,500);var e=lightning.get("invisibleRecaptcha.publicKey");$(".invisible-recaptcha").each(function(){var a=$(this).closest("form"),i=grecaptcha.render(this,{sitekey:e,size:"invisible",callback:function(e){a.submit()}});a.data("recaptcha-id",i)})},validateForm:function(e){var a=$(e.target);if(a.find(".error:visible").length>0)return!1;var i=a.find(".g-recaptcha-response");return!(i.length>0&&""===a.find(".g-recaptcha-response").val())||(grecaptcha.execute(a.data("recaptcha-id")),!1)}}}();
!function(){var t=lightning.htmleditor={editors:{},init:function(){var e=lightning.vars.htmleditors;for(var i in e)"tinymce"==e[i].editor_type?(e[i].setup=t.tinymceSetup,e[i].browser&&(e[i].file_browser_callback=t.imageBrowser),e[i].startup&&t.initEditor(i)):"ckeditor"==e[i].editor_type&&!function(i){CKEDITOR.scriptLoader.queue(CKEDITOR.getUrl("config.js"),function(){"function"==typeof CKEDITOR.editorConfig&&CKEDITOR.editorConfig(CKEDITOR.config),e[i].hasOwnProperty("plugins")?e[i].plugins=e[i].plugins.replace(/\*/,CKEDITOR.config.plugins):e[i].plugins=CKEDITOR.config.plugins,e[i].hasOwnProperty("fullPage")&&e[i].fullPage&&(e[i].plugins=e[i].plugins.replace("divarea","")),e[i].startup&&t.initEditor(i)})}(i);$(".html_editor_presave").closest("form").submit(function(){$(this).find(".html_editor_presave").each(function(){var i=$(this),n=$(this).prop("id").replace("save_","");"ckeditor"==e[n].editor_type&&i.val(t.getContent(n))})})},getContent:function(e){if("ckeditor"==lightning.vars.htmleditors[e].editor_type)return t.editors[e].getData()},initEditor:function(e){var i=$("#"+e),n=lightning.vars.htmleditors[e];n.content_rendered&&(i.html(n.content),delete n.content_rendered),i.addClass("editor-active"),"tinymce"==n.editor_type?tinymce.init(n):"ckeditor"==n.editor_type&&(i.attr("contenteditable","true"),t.editors[e]=CKEDITOR.inline(e,n))},deactivateEditor:function(e){var i=$("#"+e);if(i.removeClass("editor-active"),"tinymce"==lightning.vars.htmleditors[e].editor_type)for(var n in tinymce.editors)tinymce.editors[n].id==e&&tinymce.editors[n].remove();else"ckeditor"==lightning.vars.htmleditors[e].editor_type&&($("#"+e).attr("contenteditable","false"),t.editors[e].destroy())},tinymceSetup:function(t){t.addButton("columns",{type:"menubutton",text:"Columns",icon:!1,menu:[{text:"2 Columns",onclick:function(){t.insertContent('<div class="row"><div class="small-12 medium-6 column"><p>Column 1</p></div><div class="small-12 medium-6 column"><p>Column 2</p></div></div>')}},{text:"3 Columns",onclick:function(){t.insertContent('<div class="row"><div class="small-12 medium-4 column"><p>Column 1</p></div><div class="small-12 medium-4 column"><p>Column 2</p></div><div class="small-12 medium-4 column"><p>Column 3</p></div></div>')}},{text:"4 Columns",onclick:function(){t.insertContent('<div class="row"><div class="small-12 medium-3 column"><p>Column 1</p></div><div class="small-12 medium-3 column"><p>Column 2</p></div><div class="small-12 medium-3 column"><p>Column 3</p></div><div class="small-12 medium-3 column"><p>Column 4</p></div></div>')}}]}),t.addButton("yt",{type:"button",text:"YT",icon:!1,onclick:function(){t.insertContent('{{youtube id="" flex=true widescreen=true}}')}})},imageBrowser:function(t,e,i,n){return tinymce.activeEditor.windowManager.open({file:"/elfinder/elfinder.html?type=tinymce",title:"Image Browser",width:900,height:450,resizable:"yes"},{setUrl:function(e){n.document.getElementById(t).value=e}}),!1}}}();
...
lightning.format={sizes:["B","KB","MB","GB","TB","PB"],counts:["","k","m","b","t","q"],dataSize:function(n){return lightning.format.divide(n,1024,lightning.format.sizes,!1)},count:function(n){return lightning.format.divide(n,1e3,lightning.format.counts,!0)},divide:function(n,i,t,g){for(var e=n,r=0;e>=.9*i;)e/=i,r++;return void 0==t[r]?"Really Big":0==r&&g?e:parseFloat(e).toPrecision(3)+t[r]}},lightning.startup={init:function(){$(document).foundation(),this.initNav(),lightning.ajax.init(),lightning.dialog.init(),lightning.tracker.init(),lightning.forms.init()},initNav:function(){var n=lightning.get("menu_context");n&&$("nav ."+n).addClass("active")}},lightning.js={queue:[],loaded:{},loadScript:function(n){lightning.js.loaded[n]=!1;var i=document.createElement("script");i.src=n,i.type="text/javascript",i.async="true",i.onload=i.onreadystatechange=function(){var i=this.readyState;i&&"complete"!=i&&"loaded"!=i||(lightning.js.loaded[n]=!0,lightning.js.trigger())};var t=document.getElementsByTagName("script")[0];t.parentNode.insertBefore(i,t)},require:function(n,i){if("string"==typeof n&&(n=[n]),lightning_mv>0)for(var t in n)n[t]=n[t]+"?v="+lightning_mv;lightning.js.queue.push({urls:n,callback:i,triggered:!1});for(var t in n)lightning.js.loaded.hasOwnProperty(n[t])||lightning.js.loadScript(n[t]);lightning.js.trigger()},trigger:function(){n:for(var n in lightning.js.queue)if(!lightning.js.queue[n].triggered){for(var i in lightning.js.queue[n].urls)if(!lightning.js.loaded[lightning.js.queue[n].urls[i]])continue n;lightning.js.queue[n].triggered=!0,lightning.js.queue[n].callback()}}},lightning.require=function(n,i){lightning.js.require(n,i)},lightning.get=function(n,i){if(!n)return null;"undefined"==typeof i&&(i=null),n=n.split(".");var t=lightning.vars;for(var g in n){if(!t.hasOwnProperty(n[g]))return i;t=t[n[g]]}return t},lightning.parsed_query=null,lightning.parsed_hash=null,lightning.getFromURL=function(n,i){var t="parsed_"+n;if(null==lightning[t]){var g=document.location[n].substring(1).split("&");lightning[t]={};for(var e in g)if(0!=g[e].length){var r=g[e].split("=",2);lightning[t][r[0]]=r[1]}}return lightning[t].hasOwnProperty(i)?lightning[t][i]:null},lightning.query=function(n){return lightning.getFromURL("search",n)},lightning.hash=function(n){return lightning.getFromURL("hash",n)},lightning.modules||(lightning.modules={}),lightning.buildQuery=function(n){var i=[];for(var t in n)i.push(encodeURIComponent(t)+"="+encodeURIComponent(n[t]));return i.join("&")};
...
!function(){var e=lightning.table={init:function(){$(".add_image").on("click",e.clickAddImage),$(".linked_images").on("click",".remove",e.removeLinkedImage),$("table.table_form_table").on("click",".remove-link",function(t){var a=$(t.target);e.removeLink(a.data("link"),a.data("link-item"))}).on("click",".add-link",e.clickAddLink),e.filterContainer=$(".filters"),e.filterContainer.on("change","select",e.search),e.filterContainer.on("click",".remove",e.removeFilter),e.filterSelect=$("#filters"),e.filterSelect.on("change",e.addNewFilter),e.filters=lightning.get("table.filters",[]),e.textSearch=$("#table_search"),e.textSearch.on("keyup",e.search),$(".autocomplete_field").on("keyup",e.autocomplete),$(".autocomplete_link").on("keyup",e.autocomplete)},addNewFilter:function(){var t=e.filterSelect.val();if(""!=t){e.filterSelect.val("");var a=$('<fieldset class="filter row"><div class="small-1 column"><i class="fa fa-close remove"></i></div></fieldset>');a.data("name",t);for(var l in e.filters[t].options){if("select"==e.filters[t].options[l].type){var n=$("<select>");n.prop("name",l);for(var i in e.filters[t].options[l].options){var o=$("<option>");o.prop("value",i),o.html(e.filters[t].options[l].options[i]),n.append(o)}}a.append($('<div class="small-11 medium-5 column"></div>').append(n))}e.filterContainer.append(a),e.search()}},removeFilter:function(t){$(t.target).closest(".filter").remove(),e.search()},click:function(t){var a=t.currentTarget.id;if("INPUT"!=t.target.tagName&&void 0!=lightning.vars.table_data.rowClick)switch(lightning.vars.table_data.rowClick.type){case"url":document.location=lightning.vars.table_data.rowClick.url+a;break;case"action":document.location=e.createUrl(lightning.vars.table_data.rowClick.action,a)}},createUrl:function(e,t){var a={action:e,id:t};return lightning.vars.table_data.table&&(a.table=table_data.table),lightning.vars.table_data.parent_link&&(a[table_data.parent_link]=lightning.vars.table_data.parent_id),lightning.vars.table_data.vars&&$.extend(a,lightning.vars.table_data.vars),url="?"+lightning.buildQuery(a)},selectAll:function(e){$(".taf_"+e).prop("checked",$("#taf_all_"+e).is(":checked"))},searchTimeout:null,searchIndex:0,searchIndexDisplayed:0,search:function(){var t=e.textSearch.val(),a=[];e.filterContainer.find(".filter").each(function(){var e=$(this);a.push({filter:e.data("name"),operator:e.find('select[name="operator"] option:selected').val(),value:e.find('select[name="value"] option:selected').val()})}),e.searchIndex++,clearTimeout(e.searchTimeout),e.searchTimeout=setTimeout(function(){lightning.vars.table_data.vars.ste=t,$.ajax({url:lightning.get("table_data.action_file"),type:"GET",dataType:"json",data:{ste:t,i:e.searchIndex,action:"search",filter:a},success:function(t){t.d>e.searchIndexDisplayed&&(e.searchIndexDisplayed=t.d,$(".table_list").html(t.html))}})},500)},clickAddLink:function(t){var a=$(t.target),l=a.closest("td").find("select option:selected");e.addLink(a.data("link"),l.val(),l.html())},addLink:function(e,t,a){if(0!=e||""!=t){var l=new RegExp("(^|,)"+t+","),n=$("#"+e+"_input_array");if(null==n.val().match(l)){n.val(n.val()+t+","),$("#"+e+"_list_container").append($('<div class="'+e+'_box table_link_box_selected" id="'+e+"_box_"+t+'">'+a+' <i class="remove-link fa fa-close" data-link="'+e+'" data-link-item="'+t+'"></i></div>'));var i=lightning.get("table.linkProcess");for(var o in i)lightning.getMethodReference(i[o])()}}},removeLink:function(e,t){$("#"+e+"_box_"+t).remove();var a=$("#"+e+"_input_array"),l=a.val(),n=new RegExp("[\\^,]"+t+",","i");l=l.replace(n,","),n=new RegExp("^"+t+",","i"),l=l.replace(n,""),a.val(l)},clickAddImage:function(t){var a=t.target.id.replace("add_image_","");CKFinder.popup({basePath:lightning.vars.table.links[a].web_location,chooseFiles:!0,chooseFilesOnDblClick:!0,onInit:function(t){t.on("files:choose",function(t){var l=t.data.files.first();e.addImageCallback(a,l.getUrl())}),t.on("file:choose:resizedImage",function(t){e.addImageCallback(a,t.data.resizedUrl)})}})},addImageCallback:function(e,t){$("#linked_images_"+e).append('<span class="selected_image_container"><input type="hidden" name="linked_images_'+e+'[]" value="'+t+'"><span class="remove">X</span><img src="'+t+'" /></span>')},removeLinkedImage:function(e){$(e.target).closest(".selected_image_container").remove()},autocompleteCache:{field:{},link:{}},autocomplete:function(){var t=$(this),a=t.data("name"),l=t.val(),n=t.data("type");l.length<2||e.autocompleteCache[n][a]&&e.autocompleteCache[n][a].lastFetch===l||(e.autocompleteCache[n][a]={lastFetch:l},$.ajax({url:lightning.get("table_data.action_file"),type:"get",dataType:"json",data:{action:"autocomplete",field:t.data("name"),type:n,search:l},success:function(t){l===e.autocompleteCache[n][a].lastFetch&&e.autocompleteDropdown(a,n,t.results)}}))},autocompleteDropdown:function(t,a,l){var n=$(".autocomplete_options");if(n.each(function(){$(this).attr("id")!=="table_container_"+t?$(this).remove():$("#list_"+t).empty()}),0===n.length){var i=$("#"+t+"_autocomplete");0===i.length&&(i=$("#"+t)),i.after('<div id="table_container_'+t+'" class="autocomplete_options" data-field="'+t+'" data-type="'+a+'"><div id="list_'+t+'"></div></div>')}var o=$("#list_"+t);"link"===a&&lightning.get("table_data.links."+t+".create")&&(o.append('<span class="create">Create a new entry</span>'),o.on("click",".create",e.setAutocompleteCreateNew));for(var c in l)o.append('<span class="select" data-value="'+c+'" >'+l[c]+"</span>");o.on("click",".select",e.setAutocompleteSelection)},setAutocompleteSelection:function(t){var a=$(this),l=a.closest(".autocomplete_options"),n=l.data("field"),i=a.data("value");switch(l.remove(),l.data("type")){case"link":e.addLink(n,i,a.html());break;case"field":default:$("#"+n).val(i)}},setAutocompleteCreateNew:function(t){var a=$(this),l=a.closest(".autocomplete_options"),n=l.data("field"),i=l.closest("td").find('input[data-type="link"]').val();$.ajax({url:lightning.get("table_data.action_file"),type:"POST",dataType:"JSON",data:{action:"create-link",link:n,value:i,token:lightning.vars.token},success:function(t){l.remove(),e.addLink(n,t.id,t.value)}})},deleteSubtable:function(e){var t=$(e).closest("div").attr("id").replace("subtable_",""),a=t.split("_");a=a[a.length-1],entry_id_table=t.replace("_"+a,""),parseInt(a)>0?$("#delete_subtable_"+entry_id_table).val($("#delete_subtable_"+entry_id_table).val()+a+","):(reg=new RegExp(Math.abs(a)+","),$("#new_subtable_"+entry_id_table).val($("#new_subtable_"+entry_id_table).val().replace(reg,""))),$("#subtable_"+entry_id_table+"_"+a).fadeOut(function(){$(this).remove()})},newSubtable:function(e){"undefined"==typeof new_subtables&&(new_subtables=Array()),"undefined"==typeof new_subtables[e]?new_subtables[e]=1:new_subtables[e]++,$("#subtable_"+e+"__N_").before($("<div class='subtable' id='subtable_"+e+"_-"+new_subtables[e]+"'></div>").html($("#subtable_"+e+"__N_").html().replace(/_N_/g,"-"+new_subtables[e]))),$("#new_subtable_"+e).val($("#new_subtable_"+e).val()+new_subtables[e]+",")},newPop:function(e,t,a){e.indexOf("?")>-1?window.open(e+"&action=pop&pf="+t+"&pfdf="+a+"&pop=1","New","width=400,height=500"):window.open(e+"?action=pop&pf="+t+"&pfdf="+a+"&pop=1","New","width=400,height=500")},returnPop:function(e){window.opener.$("#"+e.pf+"_list").append("<option value='"+e.id+"'>"+e.pfdf+"</option>").val(e.id),window.close()},export:function(e){var t=$('[name="table_search"]').val();console.log(e);var a=$(e).attr("href");""!=t&&(a+="&ste="+t),window.location=a},resetField:function(e){"undefined"!=typeof CKEDITOR.instances[e]?CKEDITOR.instances[e].setData(lightning.vars.table_data.defaults[e]):"undefined"!=typeof("#"+e).val?$("#"+e).val(lightning.vars.table_data.defaults[e]):$("#"+e).html(lightning.vars.table_data.defaults[e])}}}();
!function(){var e=lightning.tracker={ready:!1,queue:[],events:{pageView:{ga:"pageview",fb:"PageView",action:"pageView"},viewContent:{fb:"ViewContent"},search:{fb:"Search"},addToCart:{fb:"AddToCart",ga:"event",category:"Store",action:"addToCart"},addToWishlist:{fb:"AddToWishlist",ga:"event",category:"Store",action:"addToWishlist"},initiateCheckout:{fb:"InitiateCheckout",ga:"event",category:"Store",action:"initiateCheckout"},addPaymentInfo:{fb:"AddPaymentInfo",ga:"event",category:"Store",action:"addPaymentInfo"},purchase:{fb:"Purchase",ga:"event",category:"Store",action:"purchase"},optin:{fb:"Lead",ga:"event",category:"User",action:"optin"},contact:{ga:"event",category:"Email",label:"Contact Sent"},register:{fb:"CompleteRegistration",ga:"event",category:"User",action:"register"},splitTest:{ga:"event",label:"Split Test"},event:{ga:"event"}},initted:{"google-analytics":!1,facebook:!1},init:function(){var a=[];lightning.vars.google_analytics_id&&a.push("//www.google-analytics.com/analytics.js"),lightning.vars.facebook_pixel_id&&(n=window.fbq=function(){n.callMethod?n.callMethod.apply(n,arguments):n.queue.push(arguments)},window._fbq||(window._fbq=n),n.push=n,n.loaded=!0,n.version="2.0",n.queue=[],a.push("//connect.facebook.net/en_US/fbevents.js")),a.length>0&&lightning.require(a,function(){if(lightning.vars.google_analytics_id)var a=new Date,n=setTimeout(function(){"undefined"!=typeof ga?(lightning.vars.debug&&console.log("Creating GA: ",lightning.vars.google_analytics_id),ga("create",lightning.vars.google_analytics_id,"auto"),e.initted["google-analytics"]=!0):new Date-a<1e4&&n()},100);lightning.vars.facebook_pixel_id&&(fbq("init",lightning.vars.facebook_pixel_id),e.initted.facebook=!0),e.track(e.events.pageView),e.ready=!0;for(var t in e.queue)e.trackOnStartup(e.queue[t])})},trackOnStartup:function(a){if(e.ready){var n=a.type,t=e.events.hasOwnProperty(n)?e.events[n]:{action:n,ga:"event"};e.track(t,{category:a.category,label:a.label})}else e.queue.push(a)},track:function(a,n){var t={};if($.extend(t,a,n),lightning.vars.google_analytics_id&&t.hasOwnProperty("ga")){var i=$.extend({category:null,action:t.fb?t.fb:t.action?t.action:null,label:null,value:null},t),o=function(){e.initted["google-analytics"]?lightning.vars.debug?console.log("Google Analytics Tracker: ",i):ga("send",i.ga,i.category,i.action,i.label,i.value):setTimeout(o,100)};o()}if(lightning.vars.facebook_pixel_id&&t.hasOwnProperty("fb")){var g=function(){e.initted.facebook?lightning.vars.debug?console.log("Facebook Tracker: ",t.fb):fbq("track",t.fb):setTimeout(g,100)};g()}if(lightning.vars.google_adwords&&t.label&&lightning.vars.google_adwords[t.label]){var l=$.extend({},lightning.vars.google_adwords[t.label]),r=l.conversion;delete l.conversion;var c="//www.googleadservices.com/pagead/conversion/"+r+"/?script=0&"+lightning.buildQuery(l);if(lightning.vars.debug)console.log("Google Adwords Tracker: "+c);else{var s=new Image(1,1);s.src=c}}}}}();
...
lightning.video={players:{},init:function(){var i=this;for(var e in lightning.vars.videos){var t=lightning.vars.videos[e];if(t.call||(t.call=[]),t.playlist){var a=$("<ul>");for(var l in t.playlist)a.append('<li id="video_link_'+e+"_"+l+'" class="playlist_link">'+t.playlist[l].title+"</li>");$("#video_playlist_"+e).html(a),$(".video_playlist").on("click",".playlist_link",this.clickPlaylist)}t.call.beforeLoad?lightning.getMethodReference(t.call.beforeLoad)(e,function(){i.load(e)}):this.load(e)}},initYouTube:function(){$(".youtube:not(.initted)").each(function(){var i="//i.ytimg.com/vi/"+this.id+"/maxresdefault.jpg",e="//i.ytimg.com/vi/"+this.id+"/hqdefault.jpg",t=new Image,a=$(this);t.onerror=function(){$(this).css("background-image","url("+e+")")},t.onload=function(){this.width<=120?a.css("background-image","url("+e+")"):a.css("background-image","url("+i+")")},t.src=i,a.append($("<div/>",{class:"play"})),a.data("autoplay")?lightning.video.playYouTube(a):$(document).delegate("#"+this.id,"click",function(){lightning.video.playYouTube($(this))}),a.addClass("initted")})},playYouTube:function(i){var e=$(i),t="https://www.youtube.com/embed/"+e.prop("id")+"?autoplay=1&autohide=1&modestbranding=0&showinfo=0&rel=0";e.data("params")&&(t+="&"+e.data("params"));var a=$("<iframe/>",{frameborder:"0",src:t,width:"100%",height:"100%"});e.replaceWith(a)},clickPlaylist:function(i){var e=i.currentTarget.id.replace("video_link_",""),t=e.match(/[0-9]+$/),a=e.replace("_"+t,"");lightning.video.players[a].dispose(),lightning.video.load(a,t,!0)},load:function(i,e,t){var a=lightning.vars.videos[i],l=$("#video_"+i);e||(e=0);var n,o=a.playlist?a.playlist[e]:a,r=o.controls||!o.hasOwnProperty("controls")&&(!a.hasOwnProperty("controls")||a.controls),s=a.hasOwnProperty("width")?a.width:640,d=a.hasOwnProperty("height")?a.width:320;if(o.mp4||o.ogg||o.webm){n="<video id=video_player_"+i+' class="video-js vjs-default-skin" width="'+s+'" height="'+d+'" poster="'+(o.still?o.still:a.still?a.still:"")+'" '+(r?"controls":"")+" preload>";for(var p in{mp4:1,ogg:1,webm:1})o[p]&&(n+='<source src="'+o[p]+'" type="video/'+p+';">');n+="</video>"}else{n=$("<audio>"),n.prop("id","video_player_"+i),n.prop("class","video-js vjs-default-skin"),n.prop("width",s),n.prop("height",d),n.prop("preload","preload"),r&&n.prop("controls","controls");var c=o.still?o.still:a.still?a.still:"";""!=c&&n.prop("poster",c);for(var p in{mp3:1,aac:1})if(o[p]){var h=$("<source>");h.prop("src",o[p]),h.prop("type","audio/"+p),n.append(h)}}l.append(n),this.players[i]=videojs(document.getElementById("video_player_"+i),{width:"100%",controls:r}),a.classes&&$("#video_player_"+i).addClass(a.classes),(a.autoPlay||t)&&(this.players[i].play(),a.startTime&&a.startTime>0&&this.players[i].currentTime(a.startTime),a.call.afterLoad&&this.players[i].one("play",a.call.afterLoad)),a.call.onEnd&&this.players[i].on("ended",lightning.getMethodReference(a.call.onEnd));var v=this;a.call.onTime&&this.players[i].on("timeupdate",function(){v.timeCallback(v.players[i],lightning.vars.videos[i].call.onTime)}),a.hasOwnProperty("analytics_events")||(a.analytics_events=!1);var g=0;a.analytics_events&&(this.players[i].on("ended",function(){lightning.video.track(i,"ended")}),this.players[i].on("pause",function(){lightning.video.track(i,"paused",v.players[i].currentTime(),!0)}),this.players[i].on("play",function(){lightning.video.track(i,"played",v.players[i].currentTime(),!0)}),this.players[i].on("timeupdate",function(){var e=parseInt(v.players[i].currentTime());g!=e&&e%10==0&&(g=e,lightning.video.track(i,"watching",e))}))},track:function(i,e,t,a){void 0==a&&(a=!1),ga("send","event","video."+i,e,"time",t,{nonInteraction:a?1:0})},timeCallback:function(i,e){var t=i.currentTime();for(var a in e)t>=a&&(lightning.getMethodReference(e[a])(),delete e[a])}};
!function(){var t=lightning.widget={id:null,container:null,initIframe:function(t){window.onmessage=function(i){"object"==typeof i.data&&i.data.hasOwnProperty("height")&&(i.data.animate?$("#"+t).animate({height:i.data.height}):$("#"+t).height(i.data.height))}},initBody:function(i){t.id=i,t.container=$("#widget-body"),t.resize()},resize:function(i){"undefined"==typeof i&&(i=!1),window.parent.postMessage({height:t.container.height(),animate:i},"*")}}}();