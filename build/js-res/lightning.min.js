...
!function(){var a=lightning.forms={formSubmit:function(a){var i=$(a.target).closest("form"),n=i.data("ajax-action");n||(n=i.prop("action"));var t=i.find(".loading-container");0==t.length&&(t=i.closest(".loading-container"));var e;t&&(e=t.children(".white-veil"),0==e.length&&t.prepend('<div class="white-veil"></div>')),e=t.children(".white-veil"),e.css("opacity",.5),console.log("sending ajax"+n)},init:function(){$(".captcha_container").closest("form").submit(function(){var a=$(this),i=0!=grecaptcha.getResponse().length;return $("#captcha_abide").val(i?1:""),a&&i}),$('form[data-abide="ajax"]').on("valid.fndtn.abide",a.formSubmit)}}}();
