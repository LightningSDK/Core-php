...
!function(){var i=lightning.forms={formSubmit:function(i){var t=$(i.target).closest("form"),a=t.data("ajax-action");a||(a=t.prop("action"));var e=t.find(".loading-container");0===e.length&&(e=t.closest(".loading-container"));var n;e&&(n=e.children(".white-veil"),0===n.length&&e.prepend('<div class="white-veil"><div class="spinner"></div></div>')),n=e.children(".white-veil"),setTimeout(function(){n.show(),n.css("opacity",.5)},100),$.ajax({url:a,type:"POST",data:t.serializeArray(),success:function(i){e.fadeOut()}})},init:function(){$(".captcha_container").closest("form").submit(function(){var i=$(this),t=0!==grecaptcha.getResponse().length;return $("#captcha_abide").val(t?1:""),i&&t}),$('form[data-abide="ajax"]').on("valid.fndtn.abide",i.formSubmit)},initInvisibleCaptcha:function(){return"undefined"==typeof grecaptcha?void setTimeout(i.initInvisibleCaptcha,500):void $(".invisible-recaptcha").each(function(){var i=$(this).closest("form");grecaptcha.render(this,{sitekey:lightning.get("invisibleRecaptcha.publicKey"),callback:function(t){i.submit()}})})}}}();
