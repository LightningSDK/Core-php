...
!function(){var i=lightning.forms={formSubmit:function(i){var e=$(i.target).closest("form"),t=e.data("ajax-action");t||(t=e.prop("action"));var a=e.find(".loading-container");0===a.length&&(a=e.closest(".loading-container"));var n;a&&(n=a.children(".white-veil"),0===n.length&&a.prepend('<div class="white-veil"><div class="spinner"></div></div>')),n=a.children(".white-veil"),setTimeout(function(){n.show(),n.css("opacity",.5)},100);var c=function(i){a.fadeOut()},r=e.data("ajax-success");r&&window[r]&&(c=window[r]),$.ajax({url:t,type:"POST",data:e.serializeArray(),success:c})},init:function(){$(".captcha_container").closest("form").submit(function(){var i=$(this),e=0!==grecaptcha.getResponse().length;return $("#captcha_abide").val(e?1:""),i&&e}),$('form[data-abide="ajax"]').on("valid.fndtn.abide",i.formSubmit)},initInvisibleCaptcha:function(){return"undefined"!=typeof grecaptcha&&grecaptcha.render?void $(".invisible-recaptcha").each(function(){var i=$(this).closest("form"),e=grecaptcha.render(this,{sitekey:lightning.get("invisibleRecaptcha.publicKey"),size:"invisible",callback:function(e){i.submit()}});i.on("submit",function(){if(0===i.find(".error:visible").length&&""===i.find(".g-recaptcha-response").val())return grecaptcha.execute(e),!1})}):void setTimeout(i.initInvisibleCaptcha,500)}}}();
