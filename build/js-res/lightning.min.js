...
!function(){var e=lightning.tracker={ready:!1,queue:[],events:{pageView:{ga:"pageview",fb:"PageView",action:"pageView"},viewContent:{fb:"ViewContent"},search:{fb:"Search"},addToCart:{fb:"AddToCart",ga:"event",category:"Store",action:"addToCart"},addToWishlist:{fb:"AddToWishlist",ga:"event",category:"Store",action:"addToWishlist"},initiateCheckout:{fb:"InitiateCheckout",ga:"event",category:"Store",action:"initiateCheckout"},addPaymentInfo:{fb:"AddPaymentInfo",ga:"event",category:"Store",action:"addPaymentInfo"},purchase:{fb:"Purchase",ga:"event",category:"Store",action:"purchase"},optin:{fb:"Lead",ga:"event",category:"User",action:"optin"},contact:{ga:"event",category:"Email",label:"Contact Sent"},register:{fb:"CompleteRegistration",ga:"event",category:"User",action:"register"},splitTest:{ga:"event",label:"Split Test"},event:{ga:"event"}},init:function(){var a=[];lightning.vars.google_analytics_id&&a.push("//www.google-analytics.com/analytics.js"),lightning.vars.facebook_pixel_id&&(n=window.fbq=function(){n.callMethod?n.callMethod.apply(n,arguments):n.queue.push(arguments)},window._fbq||(window._fbq=n),n.push=n,n.loaded=!0,n.version="2.0",n.queue=[],a.push("//connect.facebook.net/en_US/fbevents.js")),a.length>0&&lightning.require(a,function(){if(lightning.vars.google_analytics_id)var a=setTimeout(function(){ga?ga("create",lightning.vars.google_analytics_id,"auto"):a()},100);lightning.vars.facebook_pixel_id&&fbq("init",lightning.vars.facebook_pixel_id),e.track(e.events.pageView),e.ready=!0;for(var n in e.queue)e.trackOnStartup(e.queue[n])})},trackOnStartup:function(a){if(e.ready){var n=a.type,t=e.events.hasOwnProperty(n)?e.events[n]:{action:n,ga:"event"};e.track(t,{category:a.category,label:a.label})}else e.queue.push(a)},track:function(e,a){var n={};if($.extend(n,e,a),lightning.vars.google_analytics_id&&n.hasOwnProperty("ga")){var t=$.extend({category:null,action:n.fb?n.fb:n.action?n.action:null,label:null,value:null},n);lightning.vars.debug?console.log("Google Analytics Tracker: ",t):ga("send",t.ga,t.category,t.action,t.label,t.value)}if(lightning.vars.facebook_pixel_id&&n.hasOwnProperty("fb")&&(lightning.vars.debug?console.log("Facebook Tracker: ",n.fb):fbq("track",n.fb)),lightning.vars.google_adwords&&n.label&&lightning.vars.google_adwords[n.label]){var o=$.extend({},lightning.vars.google_adwords[n.label]),i=o.conversion;delete o.conversion;var g="//www.googleadservices.com/pagead/conversion/"+i+"/?script=0&"+lightning.buildQuery(o);if(lightning.vars.debug)console.log("Google Adwords Tracker: "+g);else{var r=new Image(1,1);r.src=g}}}}}();
