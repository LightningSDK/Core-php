...
!function(){var i=lightning.forms={formSubmit:function(a){var e=$(a.target).closest("form"),t=e.data("ajax-action");if(t||(t=e.prop("action")),!i.validateForm(a))return!1;var n=e.find(".loading-container");0===n.length&&(n=e.closest(".loading-container"));var c;n&&(c=n.children(".white-veil"),0===c.length&&n.prepend('<div class="white-veil"><div class="spinner"></div></div>')),c=n.children(".white-veil"),setTimeout(function(){c.show(),c.css("opacity",.5)},100);var r,s=e.data("ajax-success");r=s&&window[s]?window[s]:function(i){n.fadeOut()},$.ajax({url:t,type:"POST",data:e.serializeArray(),success:r})},init:function(){$(".captcha_container").closest("form").submit(function(){var i=$(this),a=0!==grecaptcha.getResponse().length;return $("#captcha_abide").val(a?1:""),i&&a}),$('form[data-abide="ajax"]').on("valid.fndtn.abide",i.formSubmit)},initInvisibleCaptcha:function(){if("undefined"==typeof grecaptcha||!grecaptcha.render)return void setTimeout(i.initInvisibleCaptcha,500);var a=lightning.get("invisibleRecaptcha.publicKey");$(".invisible-recaptcha").each(function(){var i=$(this).closest("form"),e=grecaptcha.render(this,{sitekey:a,size:"invisible",callback:function(a){i.submit()}});i.data("recaptcha-id",e)})},validateForm:function(i){var a=$(i.target);if(a.find(".error:visible").length>0)return!1;var e=a.find(".g-recaptcha-response");return!(e.length>0&&""===a.find(".g-recaptcha-response").val())||(grecaptcha.execute(a.data("recaptcha-id")),!1)}}}();
