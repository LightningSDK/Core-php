...
!function(){var i=lightning.forms={formSubmit:function(i){var t=$(i.target).closest("form"),a=t.data("ajax-action");a||(a=t.prop("action"));var n=t.find(".loading-container");0==n.length&&(n=t.closest(".loading-container"));var e;n&&(e=n.children(".white-veil"),0==e.length&&n.prepend('<div class="white-veil"><div class="spinner"></div></div>')),e=n.children(".white-veil"),setTimeout(function(){e.show(),e.css("opacity",.5)},100),$.ajax({url:a,type:"POST",data:t.serializeArray(),success:function(i){e.css("opacity",0),setTimeout(function(){e.hide()},500)}})},init:function(){$(".captcha_container").closest("form").submit(function(){var i=$(this),t=0!=grecaptcha.getResponse().length;return $("#captcha_abide").val(t?1:""),i&&t}),$('form[data-abide="ajax"]').on("valid.fndtn.abide",i.formSubmit)}}}();
